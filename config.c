...
wob_config_debug(struct wob_config *config)
{
	...
	wob_log_debug("config.anchor = %lu", config->anchor);
	wob_log_debug("config.overflow_mode = %lu", config->overflow_mode);
	wob_log_debug("config.output_mode = %lu", config->output_mode);
